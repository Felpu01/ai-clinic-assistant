...
def fallback(lead_type):
    return {
        "CALIENTE": "Perfecto 👌 ¿Querés que te agende un turno esta semana?",
        "TIBIO": "Te explico 👌 ¿querés que te recomiende el mejor tratamiento o agendamos?",
        "FRIO": "Hola 👋 ¿qué te gustaría consultar?"
