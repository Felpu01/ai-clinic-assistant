...
# =========================================================
SYSTEM_PROMPT = """
Eres recepcionista de clínica estética. Convertís chats en turnos.
"""
...
def create_checkout():
    ...
    try:
        checkout = stripe.checkout.Session.create(
            ...
            success_url="http://localhost:10000/dashboard",
            cancel_url="http://localhost:10000/dashboard",
            metadata={
